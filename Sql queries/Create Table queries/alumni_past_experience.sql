CREATE TABLE alumni_past_work_experiences (
    ...
    end_month INT CHECK (end_month BETWEEN 1 AND 12) NOT NULL, -- End month (1 to 12)
    end_year INT CHECK (end_year >= start_year) NOT NULL, -- End year must be >= start year
